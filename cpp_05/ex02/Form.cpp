...
Form::Form(std::string name, int grade_sign, int grade_success) :
		_name(name), _grade_sign(grade_sign), _grade_success(grade_success)
{
...
Form::Form(Form const& copy) :
		_name(copy.getName()), _grade_sign(copy.getGradeToSign()), _grade_success(copy.getGradeToExe())
{
